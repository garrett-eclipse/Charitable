...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__campaign_select__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__donation_form___ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__donation_form____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__donation_form___);
...
function CampaignSelect(_ref) {
	...
	var options = campaigns.map(function (campaign) {
		return {
			label: campaign.name,
			value: campaign.id
		};
...
var applyWithAPIData = withAPIData(function () {
	var query = stringify({
		per_page: 100,
...
/* unused harmony default export */ var _unused_webpack_default_export = (applyWithAPIData(CampaignSelect));
...
registerBlockType('charitable/donation-form', {
    ...
    edit: function edit(props) {
        ...
        return [!!props.focus && wp.element.createElement(
            ...
            wp.element.createElement(CampaignSelect, {
                key: 'campaign-select',
                label: __('Campaign'),
